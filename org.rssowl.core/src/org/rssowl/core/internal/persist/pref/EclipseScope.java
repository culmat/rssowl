...
public class EclipseScope implements IPreferenceScope {
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putBoolean(java.lang.String,
   * boolean)
   */
  public void putBoolean(String key, boolean value) {
    Assert.isTrue(key.contains(NODE_SEPARATOR), "Invalid Eclipse Preferences Key!");

    String nodePath = ROOT_NAME + key.substring(0, key.lastIndexOf(NODE_SEPARATOR));
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putInteger(java.lang.String,
   * int)
   */
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putIntegers(java.lang.String,
   * int[])
   */
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putLong(java.lang.String,
   * long)
   */
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putLongs(java.lang.String,
   * long[])
   */
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putString(java.lang.String,
   * java.lang.String)
   */
  ...
  /*
   * @see org.rssowl.core.persist.pref.IPreferenceScope#putStrings(java.lang.String,
   * java.lang.String[])
   */
