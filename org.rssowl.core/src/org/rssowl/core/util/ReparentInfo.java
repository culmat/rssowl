...
public class ReparentInfo<T, P> {
   ...
   * constructor because it performs type inferencing, removing some duplication.
   * 
   * @param <T> The type of the object that will have its parent changed. 
   * @param <P> The type of the parent.
   * @param object Non-null object to be reparented.
   * @param newParent Non-null new parent of <code>object</code>.
   * @param newPosition Neighbour of <code>object</code> in <code>newParent</code>.
   * May be <code>null</code>.
   * @param after Whether <code>object</code> will be before or after <code>
   * newPosition</code> in <code>newParent</code>. Has to be <code>null</code>
   * if <code>newPosition</code> is <code>null</code> and non-null otherwise.
   * @return ReparentInfo instance.
   */
  public final static <T, P> ReparentInfo<T, P> create(T object, P newParent,
      T newPosition, Boolean after) {
   ...
   * <code>object</code> in <code>newParent</code>. May be <code>null</code>.
   */
   ...
   * <code>newPosition</code> in <code>newParent</code>. May be <code>null</code>.
   */
