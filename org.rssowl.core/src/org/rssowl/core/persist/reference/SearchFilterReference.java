 ...
 * @author bpasero
 */
public final class SearchFilterReference extends ModelReference {
   ...
   * persistance layer.
   */
  public SearchFilterReference(long id) {
    super(id, ISearchFilter.class);
  }
   ...
   */
  @Override
  public ISearchFilter resolve() throws PersistenceException {
    return (ISearchFilter) super.resolve();
  }
}