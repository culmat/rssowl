...
@SuiteClasses({
  ...
  ModelTest1.class,
  ModelTest1.class, //Running twice to test with large block size
  ModelTest2.class,
  ModelTest2.class, //Running twice to test with large block size
  ModelTest3.class,
  ModelTest3.class, //Running twice to test with large block size
  ModelTest4.class,
  ModelTest4.class, //Running twice to test with large block size
  PreferencesDAOTest.class,
  PreferencesDAOTest.class, //Running twice to test with large block size
  ApplicationLayerTest.class,
  ApplicationLayerTest.class, //Running twice to test with large block size
  NewsFilterTest.class,
  NewsFilterTest.class, //Running twice to test with large block size
  ModelSearchTest1.class,
  ModelSearchTest2.class,
  ModelSearchTest3.class,
  ModelSearchTest4.class,
  DBManagerTest.class,
  DBManagerTest.class, //Running twice to test with large block size
  CachingDAOTest.class,
  CachingDAOTest.class, //Running twice to test with large block size
  PreferencesScopeTest.class,
  PreferencesScopeTest.class, //Running twice to test with large block size
