...
public class ModelUtilsTest {
  ...
  public void testOrphanedNewsFilters() throws Exception {
    ...
    assertTrue(!ModelUtils.isOrphaned(filter1));
    ...
    assertTrue(!ModelUtils.isOrphaned(filter2));
    ...
    assertTrue(!ModelUtils.isOrphaned(filter3));
  ...
  public void testOrphanedSearchMarks() throws Exception {
    ...
    assertTrue(!ModelUtils.isOrphaned(search1));
    ...
    assertTrue(!ModelUtils.isOrphaned(search2));
    ...
    assertTrue(!ModelUtils.isOrphaned(search3));
    ...
    assertTrue(!ModelUtils.isOrphaned(search4));
    ...
    assertTrue(!ModelUtils.isOrphaned(search5));
    ...
    assertTrue(!ModelUtils.isOrphaned(search6));
    ...
    assertTrue(!ModelUtils.isOrphaned(search7));
    ...
    assertTrue(!ModelUtils.isOrphaned(search8));
    ...
    assertTrue(!ModelUtils.isOrphaned(search9));
